...
멀티미디어 통신 세션을 생성하거나 삭제 또는 변경하기 위한 절차를 명시한 응용 계층의 시그널링 프로토콜입니다</P>
        ...
        <table width="700" border="1" cellspacing="0" cellpadding="3">
          <tr>
            <td colspan="2" align="center" bgcolor="#CCCCFF">구본</td>
            <td colspan="2" align="center" bgcolor="#CCCCFF">게이트 키퍼</td>
          </tr>
          <tr>
            <td colspan="2" align="center" bgcolor="#FFFFCC">시스템명</td>
            <td align="center">&nbsp;</td>
            <td align="center">&nbsp;</td>
          </tr>
          <tr>
            <td width="100" rowspan="2" align="center" bgcolor="#FFFFCC">시스템구성</td>
            <td width="100" align="center" bgcolor="#FFFFCC">&nbsp;</td>
